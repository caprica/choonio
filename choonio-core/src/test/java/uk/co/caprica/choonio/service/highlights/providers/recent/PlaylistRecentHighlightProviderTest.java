...
class PlaylistRecentHighlightProviderTest {
    ...
    @InjectMocks
    private PlaylistRecentHighlightProvider highlightProvider;

    @Test
    void itReturnsHighlights() {
        ReflectionTestUtils.setField(highlightProvider, "recentDays", 7);

        Recent recent1 = new Recent("1", new PlaylistId("Only Synthwave"), Instant.parse("2020-04-24T10:20:30.456Z"));
        Recent recent2 = new Recent("2", new PlaylistId("More Synthwave"), Instant.parse("2020-04-25T09:59:11.204Z"));
        ...
        StepVerifier.create(source)
            .expectNext(new Highlight(null, "Recent", "You've listened to Only Synthwave recently", new PlaylistId("Only Synthwave"), null, null))
            .expectNext(new Highlight(null, "Recent", "You've listened to More Synthwave recently", new PlaylistId("More Synthwave"), null, null))
            .verifyComplete();
    }
