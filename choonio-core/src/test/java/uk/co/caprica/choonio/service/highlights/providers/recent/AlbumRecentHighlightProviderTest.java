...
class AlbumRecentHighlightProviderTest {
    ...
    @InjectMocks
    private AlbumRecentHighlightProvider highlightProvider;
    ...
    void itReturnsHighlights() {
        ...
        StepVerifier.create(source)
            .expectNext(new Highlight(null, "Recent", "You've listened to Night at the Grindhouse recently", new AlbumId("STRNGR & Destryur", "Night at the Grindhouse"), null, null))
            .expectNext(new Highlight(null, "Recent", "You've listened to Plethora recently", new AlbumId("Ray Gun Hero", "Plethora"), null, null))
            .verifyComplete();
    }
