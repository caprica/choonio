...
class PlaylistPartOfDayHighlightProviderTest {
    ...
    @InjectMocks
    private PlaylistPartOfDayHighlightProvider highlightProvider;

    @Test
    void itReturnsHighlights() {
        when(clockService.localTime()).thenReturn(LocalTime.parse("19:27:42"));
        ...
        StepVerifier.create(source)
            .expectNext(new Highlight(null, "Part of day", "You've listened to STRNGR & Destryur in the evening", new ArtistId("STRNGR & Destryur"), null, null))
            .expectNext(new Highlight(null, "Part of day", "You've listened to Ray Gun Hero in the evening", new ArtistId("Ray Gun Hero"), null, null))
            .verifyComplete();
    }
