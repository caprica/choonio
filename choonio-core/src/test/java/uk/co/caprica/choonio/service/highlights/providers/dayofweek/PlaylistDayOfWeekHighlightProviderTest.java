...
class PlaylistDayOfWeekHighlightProviderTest {
    ...
    @InjectMocks
    private PlaylistDayOfWeekHighlightProvider highlightProvider;

    @Test
    void itReturnsHighlights() {
        when(clockService.localDate()).thenReturn(LocalDate.parse("2021-10-29"));
        ...
        StepVerifier.create(source)
            .expectNext(new Highlight(null, "Day of week", "You've listened to STRNGR & Destryur on Friday", new ArtistId("STRNGR & Destryur"), null, null))
            .expectNext(new Highlight(null, "Day of week", "You've listened to Ray Gun Hero on Friday", new ArtistId("Ray Gun Hero"), null, null))
            .verifyComplete();
    }
