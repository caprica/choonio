...
class ArtistDayOfWeekHighlightProviderTest {
    ...
    @InjectMocks
    private ArtistDayOfWeekHighlightProvider highlightProvider;

    @Test
    void itReturnsHighlights() {
        when(clockService.localDate()).thenReturn(LocalDate.parse("2021-10-30"));
        ...
        StepVerifier.create(source)
            .expectNext(new Highlight(null, "Day of week", "You've listened to STRNGR & Destryur on Saturday", new ArtistId("STRNGR & Destryur"), null, null))
            .expectNext(new Highlight(null, "Day of week", "You've listened to Ray Gun Hero on Saturday", new ArtistId("Ray Gun Hero"), null, null))
            .verifyComplete();
    }
